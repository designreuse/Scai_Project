...
<script src="<c:url value="/js/turma/form.js"/>"></script>
							...
							<div class="form-group">
								...
								<div class="col-xs-9">
									<form:input type="text" class="form-control" id="nomeTurma"
										placeholder="Nome da turma" path="nomeTurma" value="${turma.nomeTurma}"></form:input>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-4">
									<form:input type="text" class="form-control"
										...
										path="previsaoInicio" data-date-format="yyyy-mm-dd" value="${turma.previsaoInicio}"></form:input>
								</div>
								...
								<div class="col-xs-4">
									<form:input type="text" class="form-control" id="dpd2"
										...
										path="previsaoTermino" data-date-format="yyyy-mm-dd" value="${turma.previsaoTermino}"></form:input>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-4">
									<form:input type="text" class="form-control money"
										placeholder="Valor total do curso" path="valorCurso" id="valorCurso" value="${turma.valorCurso}"></form:input>
								</div>
								...
								<div class="col-xs-4">
									<form:input type="text" class="form-control numbers"
										...
										path="vagasDisponiveis" value="${turma.vagasDisponiveis}"></form:input>
								</div>
							</div>
								...
								<div class="col-xs-9">
									...
									<div class="box-body no-padding">
										<table class="table table-condensed" id="table_horarios">
											...
											<c:forEach items="${turma.horariosAulas}" var="horario">
											<tr>
...
<a href="/scai_projectV-web/turma-novo">DAITTTTTTTTTTTTTTTTTTTTTTTTT</a>"
